...
operation_tests      // Unit Tests of Clout operations
operation_time_tests // Tests of Clout operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_CLOUT_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
