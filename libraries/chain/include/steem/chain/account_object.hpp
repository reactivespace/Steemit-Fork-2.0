...
#include <clout/chain/shared_authority.hpp>
...
namespace clout { namespace chain {
   ...
   using clout::protocol::authority;

   class account_object : public object< account_object_type, account_object >
   {
         CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_object )
         ...
         account_name_type reset_account = CLOUT_NULL_ACCOUNT;
         ...
         asset             balance = asset( 0, CLOUT_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, CLOUT_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  CLOUT_MIN_COMPOUNDING_INTERVAL_SECONDS has past since cbd_last_interest_payment then
         ...
         asset             reward_clout_balance = asset( 0, CLOUT_SYMBOL );
         asset             reward_vesting_balance = asset( 0, VESTS_SYMBOL );
         asset             reward_vesting_clout = asset( 0, CLOUT_SYMBOL );
         ...
         fc::array<share_type, CLOUT_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( CLOUT_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_metadata_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_authority_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( owner_authority_history_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_recovery_request_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( change_recovery_account_request_object )
...
template<> struct is_static_length< clout::chain::account_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::vesting_delegation_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::vesting_delegation_expiration_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::change_recovery_account_request_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( clout::chain::account_object,
             ...
             (reward_clout_balance)(reward_cbd_balance)(reward_vesting_balance)(reward_vesting_clout)
...
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_object, clout::chain::account_index )

FC_REFLECT( clout::chain::account_metadata_object,
             (id)(account)(json_metadata)(posting_json_metadata) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_metadata_object, clout::chain::account_metadata_index )

FC_REFLECT( clout::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_authority_object, clout::chain::account_authority_index )

FC_REFLECT( clout::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::vesting_delegation_object, clout::chain::vesting_delegation_index )

FC_REFLECT( clout::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::vesting_delegation_expiration_object, clout::chain::vesting_delegation_expiration_index )

FC_REFLECT( clout::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( clout::chain::owner_authority_history_object, clout::chain::owner_authority_history_index )

FC_REFLECT( clout::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_recovery_request_object, clout::chain::account_recovery_request_index )

FC_REFLECT( clout::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( clout::chain::change_recovery_account_request_object, clout::chain::change_recovery_account_request_index )
