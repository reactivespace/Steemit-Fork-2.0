...
template<> struct is_static_length< clout::chain::block_summary_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( clout::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::block_summary_object, clout::chain::block_summary_index )
