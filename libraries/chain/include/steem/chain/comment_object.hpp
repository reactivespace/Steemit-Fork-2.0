...
namespace clout { namespace chain {
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( comment_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( comment_content_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( comment_smt_beneficiaries_object )
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( comment_vote_object )
...
template<> struct is_static_length< clout::chain::comment_vote_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( clout::chain::rshare_context,
            (net_rshares)(abs_rshares)(vote_rshares)(total_vote_weight)(net_votes)(author_rewards) )

FC_REFLECT( clout::chain::comment_votable_asset_options,
            (max_accepted_payout)(allow_curation_rewards)
          )

FC_REFLECT( clout::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( clout::chain::comment_object, clout::chain::comment_index )

FC_REFLECT( clout::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::comment_content_object, clout::chain::comment_content_index )

FC_REFLECT( clout::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)(symbol)
          )
CHAINBASE_SET_INDEX_TYPE( clout::chain::comment_vote_object, clout::chain::comment_vote_index )

FC_REFLECT( clout::chain::comment_smt_beneficiaries_object, (id)(comment)(smt)(beneficiaries) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::comment_smt_beneficiaries_object, clout::chain::comment_smt_beneficiaries_index )

namespace helpers
{
   using clout::chain::shared_string;

   template <>
   class index_statistic_provider<clout::chain::comment_index>
   {
   public:
      typedef clout::chain::comment_index IndexType;
      typedef typename clout::chain::comment_object::t_beneficiaries t_beneficiaries;
      typedef typename clout::chain::comment_object::t_votable_assets t_votable_assets;
   ...
   template <>
   class index_statistic_provider<clout::chain::comment_content_index>
   {
   public:
      typedef clout::chain::comment_content_index IndexType;
