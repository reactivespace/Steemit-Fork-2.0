 ...
 */
#pragma once
#include <clout/chain/block_log.hpp>
#include <clout/chain/fork_database.hpp>
#include <clout/chain/global_property_object.hpp>
#include <clout/chain/hardfork_property_object.hpp>
#include <clout/chain/node_property_object.hpp>
#include <clout/chain/notifications.hpp>

#include <clout/chain/util/advanced_benchmark_dumper.hpp>
#include <clout/chain/util/signal.hpp>

#include <clout/protocol/protocol.hpp>
...
namespace clout { namespace chain {
   ...
   using clout::protocol::operation;
   ...
   {
      fc::time_point_sec         times[ CLOUT_NUM_HARDFORKS + 1 ];
      protocol::hardfork_version versions[ CLOUT_NUM_HARDFORKS + 1 ];
   };
   ...
   class database : public chainbase::database
   {
      public:
         ...
         struct open_args
         {
            ...
            uint64_t initial_supply = CLOUT_INIT_SUPPLY;
            uint64_t cbd_initial_supply = CLOUT_CBD_INIT_SUPPLY;
         ...
         chain_id_type clout_chain_id = CLOUT_CHAIN_ID;
      ...
      public:
          ...
          *
          * Passing slot_num == 0 returns CLOUT_NULL_WITNESS
          */
         ...
         /** @return the cbd created and deposited to_account, may return CLOUT if there is no median feed */
         std::pair< asset, asset > create_cbd( const account_object& to_account, asset clout, bool to_reward_balance=false );
         asset create_vesting( const account_object& to_account, asset clout, bool to_reward_balance=false );
         ...
         share_type cashout_comment_helper( util::comment_reward_context& ctx, const comment_object& comment, const price& current_clout_price, bool forward_curation_remainder = true );
          ...
          * CLOUT.  Return 0 CBD if there isn't a current_median_history
          */
         asset to_cbd( const asset& clout )const;
         asset to_clout( const asset& cbd )const;
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = CLOUT_INIT_SUPPLY, uint64_t cbd_initial_supply = CLOUT_CBD_INIT_SUPPLY );
