...
namespace clout { namespace chain {
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( hardfork_property_object )
...
FC_REFLECT( clout::chain::hardfork_property_object,
   (id)(processed_hardforks)(last_hardfork)(current_hardfork_version)
   (next_hardfork)(next_hardfork_time) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::hardfork_property_object, clout::chain::hardfork_property_index )
