...
namespace clout { namespace chain {
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( operation_object )
...
template<> struct is_static_length< clout::chain::account_history_object > : public boost::true_type {};

} // mira
#endif

FC_REFLECT( clout::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::operation_object, clout::chain::operation_index )

FC_REFLECT( clout::chain::account_history_object, (id)(account)(sequence)(op) )

CHAINBASE_SET_INDEX_TYPE( clout::chain::account_history_object, clout::chain::account_history_index )

namespace helpers
{
   template <>
   class index_statistic_provider<clout::chain::operation_index>
   {
   public:
      typedef clout::chain::operation_index IndexType;
         ...
         if(onlyStaticInfo == false)
         {
            for(const auto& o : index)
               info._item_additional_allocation +=
                  o.serialized_op.capacity()*sizeof(clout::chain::buffer_type::value_type);
         }
   ...
   template <>
   class index_statistic_provider<clout::chain::account_history_index>
   {
   public:
      typedef clout::chain::account_history_index IndexType;
      ...
      index_statistic_info gather_statistics(const IndexType& index, bool onlyStaticInfo) const
      {
         ...
         if(onlyStaticInfo == false)
         {
            ...
            //      sizeof(clout::chain::account_history_object::operation_container::value_type);
         }
