...
FC_REFLECT( clout::chain::pending_optional_action_object,
            (id)(execution_time)(action_hash)(action) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::pending_optional_action_object, clout::chain::pending_optional_action_index )
