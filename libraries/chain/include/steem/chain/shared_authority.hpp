...
namespace clout { namespace chain {
   ...
   using clout::protocol::weight_type;
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( shared_authority )
...
FC_REFLECT_TYPENAME( clout::chain::shared_authority::account_authority_map)
FC_REFLECT( clout::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
