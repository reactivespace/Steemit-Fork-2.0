...
{
   CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_regular_balance_object );
...
{
   CLOUT_STD_ALLOCATOR_CONSTRUCTOR( account_rewards_balance_object );
...
public:
   ...
   id_type             id;
   account_name_type   name;
   asset               pending_liquid;          /// 'reward_clout_balance' for pending CLOUT
   asset               pending_vesting_shares;  /// 'reward_vesting_balance' for pending VESTS
   asset               pending_vesting_value;   /// 'reward_vesting_clout' for pending VESTS
...
FC_REFLECT( clout::chain::account_regular_balance_object,
   (id)
   (name)
   (liquid)
   (vesting_shares)
...
FC_REFLECT( clout::chain::account_rewards_balance_object,
   (id)
   (name)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_regular_balance_object, clout::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( clout::chain::account_rewards_balance_object, clout::chain::account_rewards_balance_index )
