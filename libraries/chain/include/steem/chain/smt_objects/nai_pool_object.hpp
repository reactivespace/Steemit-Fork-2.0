...
namespace clout { namespace chain {
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( nai_pool_object );
...
FC_REFLECT( clout::chain::nai_pool_object, (id)(num_available_nais)(attempts_per_block)(collisions_per_block)(last_block_id)(nais) )

CHAINBASE_SET_INDEX_TYPE( clout::chain::nai_pool_object, clout::chain::nai_pool_index )
