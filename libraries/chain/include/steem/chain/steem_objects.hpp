...
namespace clout { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert cbd to clout
    */
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( savings_withdraw_object )
    ...
    *  1000 CLOUT or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return clout_volume * cbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(clout_volume,cbd_volume) * is_positive();
         }
         ...
         {
            return ( clout_volume > 0 && cbd_volume > 0 ) ? 1 : 0;
         }
   };
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( feed_history_object )
...
template<> struct is_static_length< clout::chain::convert_request_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::escrow_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::liquidity_reward_balance_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::limit_order_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::withdraw_vesting_route_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::decline_voting_rights_request_object > : public boost::true_type {};
template<> struct is_static_length< clout::chain::reward_fund_object > : public boost::true_type {};
...
FC_REFLECT( clout::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::limit_order_object, clout::chain::limit_order_index )

FC_REFLECT( clout::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::feed_history_object, clout::chain::feed_history_index )

FC_REFLECT( clout::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::convert_request_object, clout::chain::convert_request_index )

FC_REFLECT( clout::chain::liquidity_reward_balance_object,
             (id)(owner)(clout_volume)(cbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::liquidity_reward_balance_object, clout::chain::liquidity_reward_balance_index )

FC_REFLECT( clout::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::withdraw_vesting_route_object, clout::chain::withdraw_vesting_route_index )

FC_REFLECT( clout::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::savings_withdraw_object, clout::chain::savings_withdraw_index )

FC_REFLECT( clout::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (cbd_balance)(clout_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::escrow_object, clout::chain::escrow_index )

FC_REFLECT( clout::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::decline_voting_rights_request_object, clout::chain::decline_voting_rights_request_index )

FC_REFLECT( clout::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( clout::chain::reward_fund_object, clout::chain::reward_fund_index )
