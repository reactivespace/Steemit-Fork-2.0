...
namespace clout { namespace chain {
   ...
   {
      CLOUT_STD_ALLOCATOR_CONSTRUCTOR( transaction_object )
...
FC_REFLECT( clout::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( clout::chain::transaction_object, clout::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<clout::chain::transaction_index>
   {
   public:
      typedef clout::chain::transaction_index IndexType;
      typedef typename clout::chain::transaction_object::t_packed_trx t_packed_trx;
