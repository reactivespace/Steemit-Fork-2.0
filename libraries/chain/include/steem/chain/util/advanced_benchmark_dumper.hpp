...
FC_REFLECT( clout::chain::util::advanced_benchmark_dumper::item, (op_name)(time)(count) )
FC_REFLECT( clout::chain::util::advanced_benchmark_dumper::ritem, (op_name)(time)(count) )

FC_REFLECT( clout::chain::util::advanced_benchmark_dumper::total_info< std::set< clout::chain::util::advanced_benchmark_dumper::item > >, (total_time)(items) )
FC_REFLECT( clout::chain::util::advanced_benchmark_dumper::total_info< std::multiset< clout::chain::util::advanced_benchmark_dumper::ritem > >, (total_time)(items) )
