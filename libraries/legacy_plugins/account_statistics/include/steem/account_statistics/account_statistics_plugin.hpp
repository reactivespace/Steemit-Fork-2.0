...
// time.
//
#ifndef CLOUT_ACCOUNT_STATISTICS_SPACE_ID
#define CLOUT_ACCOUNT_STATISTICS_SPACE_ID 10
#endif

#ifndef CLOUT_ACCOUNT_STATISTICS_PLUGIN_NAME
#define CLOUT_ACCOUNT_STATISTICS_PLUGIN_NAME "account_stats"
#endif
...
{
   account_stats_bucket_object_type    = ( CLOUT_ACCOUNT_STATISTICS_SPACE_ID << 8 ),
   account_activity_bucket_object_type = ( CLOUT_ACCOUNT_STATISTICS_SPACE_ID << 8 ) + 1
};
...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_cbd = 0;                   ///< CBD paid for author rewards
   share_type           author_rewards_vests = 0;                 ///< VESTS paid for author rewards
   share_type           author_rewards_total_clout_value = 0;     ///< CLOUT Value of author rewards
   ...
   share_type           curation_rewards_clout_value = 0;         ///< CLOUT Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of CLOUT paid as liquidity rewards
   ...
   share_type           clout_sent = 0;                           ///< CLOUT sent from this account
   share_type           clout_received = 0;                       ///< CLOUT received by this account
   ...
   share_type           clout_vested = 0;                         ///< CLOUT vested by the account
   ...
   share_type           clout_received_from_withdrawls = 0;       ///< CLOUT received from this account's vesting withdrawals
   share_type           clout_received_from_routes = 0;           ///< CLOUT received from another account's vesting withdrawals
   ...
   share_type           clout_converted = 0;                      ///< Amount of CLOUT that was converted
   ...
   share_type           limit_order_clout_paid = 0;               ///< CLOUT paid by limit orders
   share_type           limit_order_clout_received = 0;           ///< CLOUT received from limit orders
...
class account_statistics_plugin : public clout::app::plugin
{
   public:
      account_statistics_plugin( application* app );
      virtual ~account_statistics_plugin();

      virtual std::string plugin_name()const override { return CLOUT_ACCOUNT_STATISTICS_PLUGIN_NAME; }
...
FC_REFLECT( clout::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (clout_received_from_withdrawls)
   (clout_received_from_routes)
   ...
   (limit_order_clout_paid)
   (limit_order_clout_received)
   (limit_order_cbd_paid)
   (limit_order_cbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( clout::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   clout::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
