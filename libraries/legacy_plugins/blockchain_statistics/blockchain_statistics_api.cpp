#include <clout/blockchain_statistics/blockchain_statistics_api.hpp>
...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( clout::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( CLOUT_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const clout::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->clout_transferred                      += b.clout_transferred;
   this->cbd_transferred                        += b.cbd_transferred;
   this->cbd_paid_as_interest                   += b.cbd_paid_as_interest;
   ...
   this->cbd_paid_to_authors                    += b.cbd_paid_to_authors;
   ...
   this->clout_vested                           += b.clout_vested;
   ...
   this->cbd_conversion_requests_created        += b.cbd_conversion_requests_created;
   this->cbd_to_be_converted                    += b.cbd_to_be_converted;
   this->cbd_conversion_requests_filled         += b.cbd_conversion_requests_filled;
   this->clout_converted                        += b.clout_converted;
