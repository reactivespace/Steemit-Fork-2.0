...
#include <clout/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const clout::app::api_context& ctx );
...
FC_REFLECT( clout::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( clout::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
