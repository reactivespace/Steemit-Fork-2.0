...
// time.
//
#ifndef CLOUT_BLOCKCHAIN_STATISTICS_SPACE_ID
#define CLOUT_BLOCKCHAIN_STATISTICS_SPACE_ID 9
#endif

#ifndef CLOUT_BLOCKCHAIN_STATISTICS_PLUGIN_NAME
#define CLOUT_BLOCKCHAIN_STATISTICS_PLUGIN_NAME "chain_stats"
#endif

namespace clout { namespace blockchain_statistics {
...
{
   bucket_object_type = ( CLOUT_BLOCKCHAIN_STATISTICS_SPACE_ID << 8 )
};
...
class blockchain_statistics_plugin : public clout::app::plugin
{
   public:
      blockchain_statistics_plugin( application* app );
      virtual ~blockchain_statistics_plugin();

      virtual std::string plugin_name()const override { return CLOUT_BLOCKCHAIN_STATISTICS_PLUGIN_NAME; }
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   share_type           clout_transferred = 0;                       ///< CLOUT transferred from account to account
   ...
   share_type           cbd_paid_to_authors = 0;                     ///< Ammount of CBD paid to authors
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of CLOUT paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of CLOUT into VESTS
   share_type           clout_vested = 0;                            ///< Ammount of CLOUT vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to CLOUT
...
} } // clout::blockchain_statistics

FC_REFLECT( clout::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( clout::blockchain_statistics::bucket_object, clout::blockchain_statistics::bucket_index )
