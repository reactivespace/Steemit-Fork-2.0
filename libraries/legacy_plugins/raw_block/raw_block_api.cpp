...
#include <clout/plugins/raw_block/raw_block_api.hpp>
#include <clout/plugins/raw_block/raw_block_plugin.hpp>

namespace clout { namespace plugin { namespace raw_block {
...
{
   public:
      raw_block_api_impl( clout::app::application& _app );

      std::shared_ptr< clout::plugin::raw_block::raw_block_plugin > get_plugin();

      clout::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( clout::app::application& _app ) : app( _app )
{}

std::shared_ptr< clout::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const clout::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< clout::chain::database > db = my->app.chain_database();
