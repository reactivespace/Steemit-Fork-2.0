...
#include <clout/plugins/database_api/database_api.hpp>
#include <clout/plugins/block_api/block_api.hpp>
#include <clout/plugins/account_history_api/account_history_api.hpp>
#include <clout/plugins/account_by_key_api/account_by_key_api.hpp>
#include <clout/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <clout/plugins/tags_api/tags_api.hpp>
#include <clout/plugins/follow_api/follow_api.hpp>
#include <clout/plugins/reputation_api/reputation_api.hpp>
#include <clout/plugins/market_history_api/market_history_api.hpp>
#include <clout/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      reward_clout_balance( legacy_asset::from_asset( a.reward_clout_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_clout( legacy_asset::from_asset( a.reward_vesting_clout ) ),
   ...
   legacy_asset      reward_clout_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_clout;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting clout
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_clout_dollars( c.percent_clout_dollars ),
   ...
   uint16_t          percent_clout_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      init_cbd_supply( legacy_asset::from_asset( o.init_cbd_supply ) ),
      ...
      total_vesting_fund_clout( legacy_asset::from_asset( o.total_vesting_fund_clout ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_clout( legacy_asset::from_asset( o.total_reward_fund_clout ) ),
      ...
      pending_rewarded_vesting_clout( legacy_asset::from_asset( o.pending_rewarded_vesting_clout ) ),
   ...
   uint32_t          vote_power_reserve_rate = CLOUT_INITIAL_VOTE_POWER_RATE;
...
struct api_witness_object
{
   ...
   time_point_sec          hardfork_time_vote = CLOUT_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = CLOUT_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = CLOUT_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = CLOUT_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = CLOUT_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      clout_balance( legacy_asset::from_asset( e.clout_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v, chain_id_type c_id )
      :blockchain_version( bc_v ), clout_revision( s_v ), fc_revision( fc_v ), chain_id( c_id ) {}

   fc::string     blockchain_version;
   fc::string     clout_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      clout_volume( legacy_asset::from_asset( t.clout_volume ) ),
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      clout_volume( legacy_asset::from_asset( v.clout_volume ) ),
...
FC_REFLECT( clout::plugins::condenser_api::discussion_index,
...
FC_REFLECT( clout::plugins::condenser_api::api_account_object,
             ...
             (reward_cbd_balance)(reward_clout_balance)(reward_vesting_balance)(reward_vesting_clout)
...
FC_REFLECT_DERIVED( clout::plugins::condenser_api::extended_account, (clout::plugins::condenser_api::api_account_object),
...
FC_REFLECT( clout::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_clout_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( clout::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(init_cbd_supply)(current_cbd_supply)(confidential_cbd_supply)
            (total_vesting_fund_clout)(total_vesting_shares)
            (total_reward_fund_clout)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_clout)
            ...
            (delegation_return_period)(reverse_auction_seconds)(available_account_subsidies)(cbd_stop_percent)(cbd_start_percent)
...
FC_REFLECT( clout::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( clout::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( clout::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( clout::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( clout::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (cbd_balance)(clout_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( clout::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( clout::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( clout::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( clout::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT( clout::plugins::condenser_api::api_proposal_object,
             (id)(proposal_id)(creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink)(total_votes) )

FC_REFLECT_DERIVED( clout::plugins::condenser_api::discussion, (clout::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( clout::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( clout::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( clout::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( clout::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( clout::plugins::condenser_api::get_version_return,
            (blockchain_version)(clout_revision)(fc_revision)(chain_id) )

FC_REFLECT( clout::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( clout::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( clout::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( clout::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(clout_volume)(cbd_volume) )

FC_REFLECT( clout::plugins::condenser_api::volume,
            (clout_volume)(cbd_volume) )

FC_REFLECT( clout::plugins::condenser_api::order,
            (order_price)(real_price)(clout)(cbd)(created) )

FC_REFLECT( clout::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( clout::plugins::condenser_api::market_trade,
