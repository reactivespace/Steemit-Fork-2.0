...
#include <clout/plugins/condenser_api/condenser_api_legacy_asset.hpp>
...
namespace clout { namespace plugins { namespace condenser_api {
   ...
   struct api_chain_properties
   {
      ...
      operator legacy_chain_properties() const
      {
         ...
         props.account_creation_fee = legacy_clout_asset::from_asset( asset( account_creation_fee ) );
      ...
      uint32_t       maximum_block_size = CLOUT_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t       cbd_interest_rate = CLOUT_DEFAULT_CBD_INTEREST_RATE;
      int32_t        account_subsidy_budget = CLOUT_DEFAULT_ACCOUNT_SUBSIDY_BUDGET;
      uint32_t       account_subsidy_decay = CLOUT_DEFAULT_ACCOUNT_SUBSIDY_DECAY;
   };
   ...
   struct legacy_comment_options_operation
   {
      ...
      legacy_comment_options_operation( const comment_options_operation& op ) :
         ...
         percent_clout_dollars( op.percent_clout_dollars ),
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_clout_dollars = percent_clout_dollars;
      ...
      uint16_t          percent_clout_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         clout_amount( legacy_asset::from_asset( op.clout_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
   ...
   struct legacy_pow2_operation
   {
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_clout_asset::from_asset( asset( props.account_creation_fee ) );
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_clout( legacy_asset::from_asset( op.reward_clout ) ),
   ...
   struct legacy_smt_setup_operation
   {
      ...
      legacy_smt_setup_operation( const smt_setup_operation& op ) :
         ...
         clout_satoshi_min( op.clout_satoshi_min ),
      ...
      operator smt_setup_operation()const
      {
         ...
         op.clout_satoshi_min = clout_satoshi_min;
   ...
   struct legacy_smt_setup_ico_tier_operation
   {
      ...
      legacy_smt_setup_ico_tier_operation( const smt_setup_ico_tier_operation& op ) :
         control_account( op.control_account ),
         symbol( op.symbol ),
         clout_satoshi_cap( op.clout_satoshi_cap ),
         remove( op.remove )
      {
      ...
      operator smt_setup_ico_tier_operation()const
      {
         ...
         op.control_account = control_account;
         op.symbol = symbol;
         op.clout_satoshi_cap = clout_satoshi_cap;
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         ...
         clout_payout( legacy_asset::from_asset( op.clout_payout ) ),
...
void to_variant( const clout::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_operation& );

void to_variant( const clout::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const clout::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_pow2_work& );

void to_variant( const clout::plugins::condenser_api::legacy_smt_generation_policy&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_smt_generation_policy& );

void to_variant( const clout::plugins::condenser_api::legacy_smt_setup_parameter&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_smt_setup_parameter& );

void to_variant( const clout::plugins::condenser_api::legacy_smt_runtime_parameter&, fc::variant& );
void from_variant( const fc::variant&, clout::plugins::condenser_api::legacy_smt_runtime_parameter& );
...
FC_REFLECT( clout::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(cbd_interest_rate)(account_subsidy_budget)(account_subsidy_decay)
          )

FC_REFLECT( clout::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( clout::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( clout::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( clout::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( clout::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( clout::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( clout::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( clout::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( clout::plugins::condenser_api::legacy_transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( clout::plugins::condenser_api::legacy_withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( clout::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( clout::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( clout::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( clout::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_clout_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( clout::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(cbd_amount)(clout_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( clout::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(cbd_amount)(clout_amount) );
FC_REFLECT( clout::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( clout::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_clout)(reward_cbd)(reward_vests) )
FC_REFLECT( clout::plugins::condenser_api::legacy_delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( clout::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(cbd_payout)(clout_payout)(vesting_payout) )
FC_REFLECT( clout::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( clout::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( clout::plugins::condenser_api::legacy_smt_setup_operation, (control_account)(symbol)(max_supply)(contribution_begin_time)(contribution_end_time)(launch_time)(clout_satoshi_min)(min_unit_ratio)(max_unit_ratio)(extensions) )
FC_REFLECT( clout::plugins::condenser_api::legacy_smt_set_setup_parameters_operation, (control_account)(symbol)(setup_parameters)(extensions) )
FC_REFLECT( clout::plugins::condenser_api::legacy_smt_setup_ico_tier_operation, (control_account)(symbol)(clout_satoshi_cap)(generation_policy)(remove)(extensions) )
FC_REFLECT( clout::plugins::condenser_api::legacy_smt_set_runtime_parameters_operation, (control_account)(symbol)(runtime_parameters)(extensions))
FC_REFLECT( clout::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( clout::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( clout::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( clout::plugins::condenser_api::legacy_fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( clout::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( clout::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( clout::plugins::condenser_api::legacy_return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( clout::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(cbd_payout)(clout_payout)(vesting_payout) )
FC_REFLECT( clout::plugins::condenser_api::legacy_producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( clout::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )
FC_REFLECT( clout::plugins::condenser_api::legacy_proposal_pay_operation, (receiver)(payment)(trx_id)(op_in_trx) )
FC_REFLECT( clout::plugins::condenser_api::legacy_sps_fund_operation, (additional_funds) )
FC_REFLECT( clout::plugins::condenser_api::legacy_create_proposal_operation, (creator)(receiver)(start_date)(end_date)(daily_pay)(subject)(permlink) )

FC_REFLECT_TYPENAME( clout::plugins::condenser_api::legacy_operation )
