...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_clout_dollars( o.percent_clout_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      reward_clout_balance( a.reward_clout_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_clout( a.reward_vesting_clout ),
   ...
   asset             reward_clout_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_clout;
...
FC_REFLECT( clout::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( clout::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( clout::plugins::database_api::api_account_object,
...
FC_REFLECT( clout::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( clout::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( clout::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( clout::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( clout::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( clout::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( clout::plugins::database_api::api_signed_block_object, (clout::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( clout::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( clout::plugins::database_api::api_smt_token_object,
   (token)
   (ico)
)

FC_REFLECT_ENUM( clout::plugins::database_api::proposal_status,
                  (all)
                  (inactive)
                  (active)
                  (expired)
...
FC_REFLECT( clout::plugins::database_api::api_proposal_object,
            (id)
            (proposal_id)
            (creator)
            (receiver)
...
FC_REFLECT( clout::plugins::database_api::api_proposal_vote_object,
            (id)
            (voter)
            (proposal)
          )

FC_REFLECT( clout::plugins::database_api::order, (order_price)(decimal_price)(real_price)(for_sale)(to_receive)(created) );

FC_REFLECT( clout::plugins::database_api::order_book, (asks)(bids) );

FC_REFLECT( clout::plugins::database_api::api_smt_account_balance_object,
            (id)
            (name)
            (liquid)
            (vesting_shares)
