#include <clout/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <clout/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > CLOUT_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( CLOUT_DEBUG_NODE_API_PLUGIN_NAME );
}
