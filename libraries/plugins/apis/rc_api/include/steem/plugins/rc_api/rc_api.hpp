...
FC_REFLECT_ENUM( clout::plugins::rc::sort_order_type,
   (by_name)
   (by_edge)
   (by_pool) )

FC_REFLECT( clout::plugins::rc::list_object_args_type,
   (start)
   (limit)
   (order) )

FC_REFLECT( clout::plugins::rc::get_resource_params_return,
   (resource_names)
   (resource_params)
   (size_info) )

FC_REFLECT( clout::plugins::rc::resource_pool_api_object,
   (pool) )

FC_REFLECT( clout::plugins::rc::get_resource_pool_return,
   (resource_pool) )

FC_REFLECT( clout::plugins::rc::pool_delegation,
   (rc_manabar)
   (max_mana) )

FC_REFLECT( clout::plugins::rc::rc_account_api_object,
   (account)
   (creator)
   (rc_manabar)
...
FC_REFLECT( clout::plugins::rc::find_rc_accounts_args,
   (accounts) )

FC_REFLECT( clout::plugins::rc::find_rc_accounts_return,
   (rc_accounts) )

FC_REFLECT( clout::plugins::rc::find_rc_delegation_pools_args,
   (accounts) )

FC_REFLECT( clout::plugins::rc::find_rc_delegation_pools_return,
   (rc_delegation_pools) )

FC_REFLECT( clout::plugins::rc::find_rc_delegations_args,
   (account) )

FC_REFLECT( clout::plugins::rc::find_rc_delegations_return,
   (rc_delegations) )
