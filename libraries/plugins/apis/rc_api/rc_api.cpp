#include <clout/plugins/rc_api/rc_api_plugin.hpp>
#include <clout/plugins/rc_api/rc_api.hpp>

#include <clout/plugins/rc/rc_objects.hpp>
#include <clout/plugins/rc/resource_sizes.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< clout::plugins::chain::chain_plugin >().db() ) {}
...
{
   static_assert( CLOUT_RC_MAX_INDEL <= RC_API_SINGLE_QUERY_LIMIT, "CLOUT_RC_MAX_INDEL exceeds RC_API_SINGLE_QUERY_LIMIT" );

   find_rc_delegations_return result;
   result.rc_delegations.reserve( CLOUT_RC_MAX_INDEL );
...
{
   JSON_RPC_REGISTER_API( CLOUT_RC_API_PLUGIN_NAME );
}
