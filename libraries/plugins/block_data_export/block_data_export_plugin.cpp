...
namespace clout { namespace plugins { namespace block_data_export {
...
FC_REFLECT( clout::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace clout { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // clout::plugins::block_data_export
