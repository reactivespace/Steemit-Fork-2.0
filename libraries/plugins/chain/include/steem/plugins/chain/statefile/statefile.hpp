...
struct clout_version_info
{
   clout_version_info( const database& db );
   clout_version_info() {}
...
} } } } // namespace clout::plugins::chain::statefile

FC_REFLECT( clout::plugins::chain::statefile::clout_version_info,
   (db_format_version)
   (network_type)
   (object_schemas)
   (config)
...
FC_REFLECT( clout::plugins::chain::statefile::state_header,
   (version)
   (plugin_options)
   (sections)
   )

FC_REFLECT( clout::plugins::chain::statefile::object_section,
   (object_type)
   (format)
   (object_count)
   (next_id)
...
FC_REFLECT_TYPENAME( clout::plugins::chain::statefile::section_header )

FC_REFLECT( clout::plugins::chain::statefile::section_footer,
   (hash)
   (begin_offset)
   (end_offset)
   )

FC_REFLECT_DERIVED( clout::plugins::chain::statefile::state_footer,
   (clout::plugins::chain::statefile::section_footer),
   (section_footers)
   (footer_begin)
   )
