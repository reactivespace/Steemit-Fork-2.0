...
#ifndef CLOUT_FOLLOW_SPACE_ID
#define CLOUT_FOLLOW_SPACE_ID 8
#endif

enum follow_plugin_object_type
{
   follow_object_type            = ( CLOUT_FOLLOW_SPACE_ID << 8 ),
   feed_object_type              = ( CLOUT_FOLLOW_SPACE_ID << 8 ) + 1,
   reputation_object_type        = ( CLOUT_FOLLOW_SPACE_ID << 8 ) + 2,
   blog_object_type              = ( CLOUT_FOLLOW_SPACE_ID << 8 ) + 3,
   follow_count_object_type      = ( CLOUT_FOLLOW_SPACE_ID << 8 ) + 4,
   blog_author_stats_object_type = ( CLOUT_FOLLOW_SPACE_ID << 8 ) + 5
};
...
{
   CLOUT_STD_ALLOCATOR_CONSTRUCTOR( feed_object );
...
/**
 *  This index is maintained to get an idea of which authors are reclouted by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were reclouted by this blog
 */
...
FC_REFLECT_ENUM( clout::plugins::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( clout::plugins::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::follow_object, clout::plugins::follow::follow_index )

FC_REFLECT( clout::plugins::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::feed_object, clout::plugins::follow::feed_index )

FC_REFLECT( clout::plugins::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::blog_object, clout::plugins::follow::blog_index )

FC_REFLECT( clout::plugins::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::reputation_object, clout::plugins::follow::reputation_index )

FC_REFLECT( clout::plugins::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::follow_count_object, clout::plugins::follow::follow_count_index )

FC_REFLECT( clout::plugins::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::follow::blog_author_stats_object, clout::plugins::follow::blog_author_stats_index );

namespace helpers
{
   template <>
   class index_statistic_provider<clout::plugins::follow::feed_index>
   {
   public:
      typedef clout::plugins::follow::feed_index IndexType;
      typedef typename clout::plugins::follow::feed_object::t_reblogged_by_container t_reblogged_by_container;
