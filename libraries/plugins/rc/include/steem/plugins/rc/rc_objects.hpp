...
#include <clout/plugins/rc/rc_utility.hpp>
...
#ifndef CLOUT_RC_SPACE_ID
#define CLOUT_RC_SPACE_ID 16
#endif

#define CLOUT_RC_DRC_FLOAT_LEVEL   (20*CLOUT_1_PERCENT)
#define CLOUT_RC_MAX_DRC_RATE      1000

enum rc_object_types
{
   rc_resource_param_object_type          = ( CLOUT_RC_SPACE_ID << 8 ),
   rc_pool_object_type                    = ( CLOUT_RC_SPACE_ID << 8 ) + 1,
   rc_account_object_type                 = ( CLOUT_RC_SPACE_ID << 8 ) + 2,
   rc_delegation_pool_object_type         = ( CLOUT_RC_SPACE_ID << 8 ) + 3,
   rc_delegation_from_account_object_type = ( CLOUT_RC_SPACE_ID << 8 ) + 4,
   rc_indel_edge_object_type              = ( CLOUT_RC_SPACE_ID << 8 ) + 5,
   rc_outdel_drc_edge_object_type         = ( CLOUT_RC_SPACE_ID << 8 ) + 6
};
...
class rc_resource_param_object : public object< rc_resource_param_object_type, rc_resource_param_object >
{
   public:
      ...
      id_type               id;
      fc::int_array< rc_resource_params, CLOUT_NUM_RESOURCE_TYPES >
                            resource_param_array;
};

CLOUT_OBJECT_ID_TYPE( rc_resource_param );
...
class rc_pool_object : public object< rc_pool_object_type, rc_pool_object >
{
   public:
      ...
      id_type               id;
      fc::int_array< int64_t, CLOUT_NUM_RESOURCE_TYPES >
                            pool_array;
};

CLOUT_OBJECT_ID_TYPE( rc_pool );
...
CLOUT_OBJECT_ID_TYPE( rc_account );
...
class rc_delegation_pool_object : public object< rc_delegation_pool_object_type, rc_delegation_pool_object >
{
   public:
      ...
      clout::chain::util::manabar   rc_pool_manabar;
      int64_t                       max_rc = 0;
};

CLOUT_OBJECT_ID_TYPE( rc_delegation_pool );
...
CLOUT_OBJECT_ID_TYPE( rc_delegation_from_account );
...
CLOUT_OBJECT_ID_TYPE( rc_indel_edge );
 ...
 *
 * However, if the pool drops below CLOUT_RC_DRC_FLOAT_LEVEL, DRC:RC exchange rate starts
 * to rise according to `f(x) = 1/(a+b*x)` where `x` is the pool level, and coefficients `a`,
 * `b` are set such that `f(CLOUT_RC_DRC_FLOAT_LEVEL) = 1` and `f(0) = CLOUT_RC_MAX_DRC_RATE`.
 *
...
class rc_outdel_drc_edge_object : public object< rc_outdel_drc_edge_object_type, rc_outdel_drc_edge_object >
{
   public:
      ...
      asset_symbol_type             asset_symbol;
      clout::chain::util::manabar   drc_manabar;
      int64_t                       drc_max_mana = 0;
};

CLOUT_OBJECT_ID_TYPE( rc_outdel_drc_edge );

int64_t get_maximum_rc( const clout::chain::account_object& account, const rc_account_object& rc_account );
...
FC_REFLECT( clout::plugins::rc::rc_resource_param_object, (id)(resource_param_array) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_resource_param_object, clout::plugins::rc::rc_resource_param_index )

FC_REFLECT( clout::plugins::rc::rc_pool_object, (id)(pool_array) )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_pool_object, clout::plugins::rc::rc_pool_index )

FC_REFLECT( clout::plugins::rc::rc_account_object,
   (id)
   (account)
   (creator)
   (rc_manabar)
...
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_account_object, clout::plugins::rc::rc_account_index )

FC_REFLECT( clout::plugins::rc::rc_delegation_pool_object,
   (id)
   (account)
   (asset_symbol)
   (rc_pool_manabar)
...
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_delegation_pool_object, clout::plugins::rc::rc_delegation_pool_index )

FC_REFLECT( clout::plugins::rc::rc_delegation_from_account_object,
   (id)
   (account)
   (amount)
   )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_delegation_from_account_object, clout::plugins::rc::rc_delegation_from_account_index )

FC_REFLECT( clout::plugins::rc::rc_indel_edge_object,
   (id)
   (from_account)
   (to_pool)
   (amount)
   )
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_indel_edge_object, clout::plugins::rc::rc_indel_edge_index )

FC_REFLECT( clout::plugins::rc::rc_outdel_drc_edge_object,
   (id)
   (from_pool)
   (to_account)
   (asset_symbol)
...
CHAINBASE_SET_INDEX_TYPE( clout::plugins::rc::rc_outdel_drc_edge_object, clout::plugins::rc::rc_outdel_drc_edge_index )
