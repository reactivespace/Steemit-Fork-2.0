...
#include <clout/plugins/block_data_export/exportable_block_data.hpp>

#include <clout/plugins/stats_export/stats_export_plugin.hpp>
...
namespace clout { namespace plugins { namespace stats_export {

using clout::chain::block_notification;
using clout::chain::database;
...
using clout::plugins::block_data_export::exportable_block_data;

using clout::plugins::chain::chain_plugin;
...
FC_REFLECT( clout::plugins::stats_export::detail::api_stats_transaction_data_object, (user)(size) )
FC_REFLECT( clout::plugins::stats_export::detail::api_stats_export_data_object, (global_properties)(transaction_stats)(free_memory) )

namespace clout { namespace plugins { namespace stats_export { namespace detail {
...
{
   std::shared_ptr< api_stats_export_data_object > stats = _export_plugin.find_export_data< api_stats_export_data_object >( CLOUT_STATS_EXPORT_PLUGIN_NAME );
   if( !stats )
      return;
...
void stats_export_plugin::plugin_initialize( const boost::program_options::variables_map& options )
{
   ...
   try
   {
      ...
      my->_export_plugin.register_export_data_factory( CLOUT_STATS_EXPORT_PLUGIN_NAME,
