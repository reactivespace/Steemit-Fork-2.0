#pragma once
#include <clout/plugins/statsd/statsd_plugin.hpp>

#include <fc/optional.hpp>
#include <fc/time.hpp>

namespace clout { namespace plugins { namespace statsd { namespace util {

using clout::plugins::statsd::statsd_plugin;
...
} } } } // clout::plugins::statsd::util

#define STATSD_INCREMENT( NAMESPACE, STAT, KEY, FREQ )   \
if( clout::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   clout::plugins::statsd::util::get_statsd().increment( \
...
if( clout::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   clout::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( clout::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   clout::plugins::statsd::util::get_statsd().count(     \
...
if( clout::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   clout::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< clout::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( clout::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = clout::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, clout::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( clout::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   clout::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      clout::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
