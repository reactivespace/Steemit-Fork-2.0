...
#define CLOUT_WITNESS_PLUGIN_NAME "witness"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      ...
      (clout::plugins::token_emissions::token_emissions_plugin)
   )

   witness_plugin();
   virtual ~witness_plugin();

   static const std::string& name() { static std::string name = CLOUT_WITNESS_PLUGIN_NAME; return name; }
