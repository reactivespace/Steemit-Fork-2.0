 ...
 * - Length is between (inclusive) CLOUT_MIN_ACCOUNT_NAME_LENGTH and CLOUT_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace clout::protocol


FC_REFLECT_TYPENAME( clout::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( clout::protocol::authority::key_authority_map)
FC_REFLECT( clout::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( clout::protocol::authority::classification, (owner)(active)(key)(posting) )
