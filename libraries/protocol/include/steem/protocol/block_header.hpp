...
FC_REFLECT_TYPENAME( clout::protocol::block_header_extensions )

FC_REFLECT( clout::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( clout::protocol::signed_block_header, (clout::protocol::block_header), (witness_signature) )
