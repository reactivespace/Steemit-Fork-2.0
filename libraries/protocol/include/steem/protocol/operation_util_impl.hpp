...
//
// Place CLOUT_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define CLOUT_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace clout { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( clout::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( clout::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* clout::protocol */
