...
#include <clout/protocol/clout_virtual_operations.hpp>
...
/*namespace fc {
    void to_variant( const clout::protocol::operation& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  clout::protocol::operation& vo );
}*/

CLOUT_DECLARE_OPERATION_TYPE( clout::protocol::operation )
FC_REFLECT_TYPENAME( clout::protocol::operation )
