...
#include <clout/protocol/legacy_asset.hpp>
...
namespace clout { namespace protocol {
    ...
    *  @see SMT spec for details: https://github.com/cloutit/smt-whitepaper/blob/master/smt-manual/manual.md
    */
    ...
    *  The percent_clout_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      uint16_t          percent_clout_dollars  = CLOUT_100_PERCENT; /// the percent of Clout Dollars to key, unkept amounts will be received as Clout Power
    ...
    * @ingroup operations
    *
    * @brief Transfers CLOUT from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             clout_amount = asset( 0, CLOUT_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      asset             clout_amount = asset( 0, CLOUT_SYMBOL ); ///< the amount of clout to release
   ...
   /**
    *  This operation converts liquid token (CLOUT or liquid SMT) into VFS (Vesting Fund Shares,
   ...
   struct transfer_to_vesting_operation : public base_operation
   {
      ...
      asset             amount;  ///< must be CLOUT or liquid variant of SMT
    ...
    * vests to clout and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in CLOUT, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_clout_asset account_creation_fee = legacy_clout_asset::from_amount( CLOUT_MIN_ACCOUNT_CREATION_FEE );
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= CLOUT_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= CLOUT_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( cbd_interest_rate >= 0 );
         FC_ASSERT( cbd_interest_rate <= CLOUT_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, CLOUT_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between clout and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between CLOUT and CBD,
    *  The funds are deposited after CLOUT_CONVERSION_DELAY
    */
    ...
    * CLOUT_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting clout.
    *
    * The result of the operation is to transfer the full VESTING CLOUT balance
...
FC_REFLECT( clout::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( clout::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( clout::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( clout::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( clout::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( clout::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( clout::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( clout::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( clout::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( clout::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( clout::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( clout::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( clout::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (cbd_interest_rate)
          )

FC_REFLECT_TYPENAME( clout::protocol::pow2_work )
FC_REFLECT( clout::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( clout::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( clout::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( clout::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( clout::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( clout::protocol::account_update2_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( clout::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( clout::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( clout::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( clout::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( clout::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( clout::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( clout::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( clout::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( clout::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( clout::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( clout::protocol::vote2_operation, (voter)(author)(permlink)(rshares)(extensions) )
FC_REFLECT( clout::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( clout::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( clout::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( clout::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( clout::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( clout::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( clout::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( clout::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( clout::protocol::comment_payout_beneficiaries, (beneficiaries) )


FC_REFLECT( clout::protocol::votable_asset_options, (max_accepted_payout)(allow_curation_rewards)(beneficiaries) )
FC_REFLECT( clout::protocol::allowed_vote_assets, (votable_assets) )

FC_REFLECT_TYPENAME( clout::protocol::comment_options_extension )
FC_REFLECT( clout::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_clout_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( clout::protocol::escrow_transfer_operation, (from)(to)(cbd_amount)(clout_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( clout::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( clout::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( clout::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(cbd_amount)(clout_amount) );
FC_REFLECT( clout::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( clout::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( clout::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( clout::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( clout::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( clout::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( clout::protocol::claim_reward_balance_operation, (account)(reward_clout)(reward_cbd)(reward_vests) )
FC_REFLECT( clout::protocol::claim_reward_balance2_operation, (account)(reward_tokens)(extensions) )
FC_REFLECT( clout::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
