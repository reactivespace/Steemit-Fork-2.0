...
namespace clout { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), cbd_payout(s), clout_payout(st), vesting_payout(v){}
   ...
   struct comment_benefactor_reward_operation : public virtual_operation
   {
      ...
      comment_benefactor_reward_operation( const account_name_type& b, const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         : benefactor( b ), author( a ), permlink( p ), cbd_payout( s ), clout_payout( st ), vesting_payout( v ) {}
...
FC_REFLECT( clout::protocol::author_reward_operation, (author)(permlink)(cbd_payout)(clout_payout)(vesting_payout) )
FC_REFLECT( clout::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( clout::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( clout::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( clout::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( clout::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( clout::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( clout::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( clout::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( clout::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( clout::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( clout::protocol::comment_payout_update_operation, (author)(permlink) )
FC_REFLECT( clout::protocol::return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( clout::protocol::comment_benefactor_reward_operation, (benefactor)(author)(permlink)(cbd_payout)(clout_payout)(liquid_payout)(vesting_payout) )
FC_REFLECT( clout::protocol::producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( clout::protocol::clear_null_account_balance_operation, (total_cleared) )
FC_REFLECT( clout::protocol::sps_fund_operation, (additional_funds) )
