...
#include <clout/protocol/fixed_string.hpp>
...
namespace clout {
   ...
   namespace protocol {
      ...
      #define CLOUT_INIT_PUBLIC_KEY (clout::protocol::public_key_type(CLOUT_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const clout::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  clout::protocol::public_key_type& vo );
    void to_variant( const clout::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, clout::protocol::extended_public_key_type& vo );
    void to_variant( const clout::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, clout::protocol::extended_private_key_type& vo );
}

FC_REFLECT( clout::protocol::public_key_type, (key_data) )
FC_REFLECT( clout::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( clout::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( clout::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( clout::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( clout::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( clout::protocol::share_type )

FC_REFLECT( clout::void_t, )
