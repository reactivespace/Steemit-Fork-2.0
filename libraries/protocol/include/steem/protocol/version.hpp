...
/*
 * This class represents the basic versioning scheme of the Clout blockchain.
...
{
   class variant;
   void to_variant( const clout::protocol::version& v, variant& var );
   void from_variant( const variant& var, clout::protocol::version& v );

   void to_variant( const clout::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, clout::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( clout::protocol::version, (v_num) )
FC_REFLECT_DERIVED( clout::protocol::hardfork_version, (clout::protocol::version), )

FC_REFLECT( clout::protocol::hardfork_version_vote, (hf_version)(hf_time) )
