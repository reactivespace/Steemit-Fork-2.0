...
#define CLOUT_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
CLOUT_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define CLOUT_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define CLOUT_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define CLOUT_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
CLOUT_DECLARE_SCHEMA_CLASS( false, false )
CLOUT_DECLARE_SCHEMA_CLASS(  true, false )
CLOUT_DECLARE_SCHEMA_CLASS(  true,  true )
