...
using namespace clout::utilities;
...
{
   public:
      wallet_api( const wallet_data& initial_data, const clout::protocol::chain_id_type& _clout_chain_id, fc::api< remote_node_api > rapi, std::shared_ptr<fc::rpc::cli> _cli );
      virtual ~wallet_api();
       ...
       *  'info' wallet command.
       *
       *  These accounts are created with combination of CLOUT and delegated SP
       *
       *  @param creator The account creating the new account
       *  @param clout_fee The amount of the fee to be paid with CLOUT
      ...
      /**
       * Transfer funds from one account to another. CLOUT and CBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       * @param amount The funds being transferred. i.e. "100.000 CLOUT"
      ...
      /**
       * Transfer funds from one account to another using escrow. CLOUT and CBD can be transferred.
       *
       * @param from The account the funds are coming from
       * @param to The account the funds are going to
       ...
       * @param clout_amount The amount of CLOUT to transfer
       ...
       * @param clout_amount The amount of CLOUT that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer CLOUT into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of CLOUT is vesting.
       *
       * @param from The account the CLOUT is coming from
       * @param to The account getting the VESTS
       * @param amount The amount of CLOUT to vest i.e. "100.00 CLOUT"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *    withdrawn and deposited back as CLOUT. i.e. "10.000000 VESTS"
       * @param broadcast true if you wish to broadcast the transaction
       */
       ...
       *
       * @param from The account the VESTS are withdrawn from.
       * @param to   The account receiving either VESTS or CLOUT.
      ...
      /**
       *  This method will convert CBD to CLOUT at the current_median_history price one
      ...
      /**
       * A witness can public a price feed for the CLOUT:CBD market. The median price feed is used
       * to process conversion requests from CBD to CLOUT.
       *
       ...
       *                       operations defined in `clout/chain/operations.hpp`
      ...
      /**
       * Gets the current order book for CLOUT:CBD
       *
       ...
       *  @param amount_to_sell The amount of either CBD or CLOUT you wish to sell
      ...
      /**
       * Vote on a comment to be paid CLOUT
       *
       ...
       * @param daily_pay  - the amount of CBD that is being requested to be paid out daily,
       ...
       *  @param clout_satoshi_min The minimum clout satoshis required for a successful ICO
       ...
       *  @param control_account The name of the controlling account
       *  @param symbol The asset symbol of the created token
       *  @param clout_satoshi_cap The maximum amount of CLOUT this ICO tier applies to
       *  @param json_generation_policy The clout and token destination routes of the ICO process
       *  @param broadcast To broadcast this transaction or not
       */
...
FC_REFLECT( clout::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( clout::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( clout::wallet::plain_keys, (checksum)(keys) )

FC_REFLECT_ENUM( clout::wallet::authority_type, (owner)(active)(posting) )

FC_API( clout::wallet::wallet_api,
        /// wallet api
        (help)(gethelp)
...
FC_REFLECT( clout::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
