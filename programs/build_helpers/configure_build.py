...
def parse_arguments(src_default):
    ...
    parser = MyParser(description="Helper function to call cmake with appropriate configuration to build Clout.")
    ...
    parser.add_argument("--src", dest="source_dir", metavar="SOURCEDIR", type=convert_to_dir, default=argparse.SUPPRESS, 
                        help="Clout source directory (if omitted, will assume is at ../.. relative to location of this script)")
