...
#include <clout/schema/schema.hpp>
#include <clout/schema/schema_impl.hpp>
#include <clout/schema/schema_types.hpp>

#include <clout/chain/schema_types/oid.hpp>
#include <clout/protocol/schema_types/account_name_type.hpp>
#include <clout/protocol/schema_types/asset_symbol_type.hpp>
...
using clout::schema::abstract_schema;
...
FC_REFLECT( clout_schema, (schema_map)(chain_object_types) )

int main( int argc, char** argv, char** envp )
{
   clout::chain::database db;
   clout::chain::database::open_args db_args;
   ...
   /*
   db.for_each_index_extension< clout::chain::index_info >(
      [&]( std::shared_ptr< clout::chain::index_info > info )
      {
         std::string name;
   ...
   */
   add_to_schema_map( ss.schema_map, clout::schema::get_schema_for_type< clout::protocol::signed_block >() );
