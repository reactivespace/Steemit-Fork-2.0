...
while (( "$#" )); do
   case "$1" in
      ...
      -p|--stats-dump-period)
         ...
         ;;
      -h|--help)
         echo "Specify data directory with '--data-dir' (Default is ~/.cloutd)"
         echo "Specify cloutd directory with '--cloutd-dir' (Default is ../..)"
...
cd "$CLOUTD_DIR/libraries/vendor/rocksdb/tools/advisor"
