...
int main( int argc, char** argv, char** envp )
{
   ...
   schemas.push_back( get_schema_for_type< clout::chain::account_object >() );
   schemas.push_back( get_schema_for_type< clout::chain::comment_object >() );
