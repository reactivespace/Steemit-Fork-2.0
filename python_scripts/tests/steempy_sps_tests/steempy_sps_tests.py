...
def test_create_proposal(node, creator_account, receiver_account, wif, subject):
    ...
    ret = s.commit.post("Cloutpy proposal title", "Cloutpy proposal body", creator["name"], permlink = "cloutpy-proposal-title", tags = "proposals")
...
if __name__ == '__main__':
    ...
    try:
        if node is None or node.is_running():
            ...
            clout_utils.clout_tools.wait_for_blocks_produced(2, node_url)
