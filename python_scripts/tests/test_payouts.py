...
# local imports
from cloutdebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a cloutd debug node on an existing chain, trigger a hardfork' \
...
def run_cloutd_tests( debug_node ):
   from cloutapi.cloutnoderpc import CloutNodeRPC
   ...
   try:
      ...
      rpc = CloutNodeRPC( 'ws://127.0.0.1:8095', '', '' )
