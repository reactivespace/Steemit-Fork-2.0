...
if __name__ == '__main__':
  ...
  parser.add_argument("--node-ip", help = "IP address of clout node", default = "http://127.0.0.1", dest = "node_ip")
  parser.add_argument("--node-port", help = "Clout node port", default = 8751, dest = "node_port")
