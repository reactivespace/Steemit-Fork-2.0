...
/*
namespace clout { namespace plugin_tests {

using namespace clout::app;
using namespace clout::chain;
...
CLOUT_DEFINE_PLUGIN_EVALUATOR( test_plugin, test_a_operation, test_a );
CLOUT_DEFINE_PLUGIN_EVALUATOR( test_plugin, test_b_operation, test_b );
...
CLOUT_DEFINE_PLUGIN( test, clout::plugin_tests::test_plugin )

FC_REFLECT( clout::plugin_tests::test_a_operation, (account) )
FC_REFLECT( clout::plugin_tests::test_b_operation, (account) )

CLOUT_DECLARE_OPERATION_TYPE( clout::plugin_tests::test_op );
FC_REFLECT_TYPENAME( clout::plugin_tests::test_op );
CLOUT_DEFINE_OPERATION_TYPE( clout::plugin_tests::test_op );
*/
