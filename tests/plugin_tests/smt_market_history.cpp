...
BOOST_AUTO_TEST_CASE( smt_mh_test )
{
   ...
   try
   {
      ...
      appbase::app().initialize<
         clout::plugins::market_history::market_history_plugin,
      ...
      BOOST_REQUIRE( bucket->clout.high == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_clout.high == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.low == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.open == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.open == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.close == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_clout.close == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->clout.high == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_clout.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.close == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_clout.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.volume == asset( 250, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->clout.high == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_clout.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_clout.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.volume == ASSET( "0.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.volume == asset( 500, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->clout.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_clout.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->open == CLOUT_GENESIS_TIME );
      BOOST_REQUIRE( bucket->clout.high == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_clout.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.low == asset( 750, any_smt_symbol ).amount );
      ...
      BOOST_REQUIRE( bucket->clout.close == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->non_clout.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->clout.volume == ASSET( "2.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_clout.volume == asset( 1500, any_smt_symbol ).amount );
      bucket++;
