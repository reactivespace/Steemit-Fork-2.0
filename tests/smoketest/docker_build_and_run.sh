...
#
# sudo ./docker_build_and_run.sh ~/cloutit/clout/build/Release/programs/cloutd ~/cloutit/clout/build/Release/programs/cloutd ~/cloutit/cloutd_data/cloutnet ~/cloutit/cloutd_data/cloutnet ~/cloutit/logs 5000000 12

if [ $# -lt 6 -o $# -gt 8 ]
then
   echo "Usage: reference_cloutd_location tested_cloutd_location ref_blockchain_folder_location tested_blockchain_folder_location"
   echo "       logs_dir stop_at_block [jobs [--dont-copy-config]"
   echo "Example: ~/cloutit/ref_cloutd ~/cloutit/clout/build/Release/programs/cloutd ~/cloutit/cloutnet ~/cloutit/testnet"
   echo "         ~/cloutit/logs 5000000 12"
